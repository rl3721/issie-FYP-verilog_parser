...
type ASTNode =
    ...
    | LoopGenerateConstruct of LoopGenerateConstructT
...
let getItem (item: ItemT)  =
    ...
    match item.IODecl, item.ParamDecl, item.Decl, item.Statement, item.AlwaysConstruct, 
        item.ModuleInstantiation, item.GenerateRegion, item.GenVarId, item.IfGenerateConstruct, item.LoopGenerateConstruct with
    | Some ioDecl, None, None, None, None, None, None, None, None, None -> IOItem ioDecl
    | None, Some paramDecl, None, None, None, None, None, None, None, None -> ParamDecl paramDecl
    | None, None, Some decl, None, None, None, None, None, None, None -> Declaration decl
    | None, None, None, Some contAssign, None, None, None, None, None, None -> ContinuousAssign contAssign
    | None, None, None, None, Some always, None, None, None, None, None -> AlwaysConstruct always
    | None, None, None, None, None, Some moduleInst, None, None, None, None -> ModuleInstantiation moduleInst
    | None, None, None, None, None, None, Some generateRegion, None, None, None -> GenerateRegion generateRegion
    | None, None, None, None, None, None, None, Some genVarId, None, None -> GenVarDeclaration genVarId
    | None, None, None, None, None, None, None, None, Some ifGenConstruct, None -> IfGenerateConstruct ifGenConstruct
    | None, None, None, None, None, None, None, None, None, Some loopGenConstruct -> LoopGenerateConstruct loopGenConstruct
    | anything ->
        printfn $"{anything}"
        printfn $"{item}"   
