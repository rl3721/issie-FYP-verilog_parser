...
LIST_OF_VARIABLES
    -> NAME_OF_VARIABLE _ %comma _ LIST_OF_VARIABLES {%function(d) {return {Type: "list_of_port_identifiers", Head: d[0], Tail: d[4]};} %}
    | NAME_OF_VARIABLE {% function(d) {return {Type: "list_of_port_identifiers", Head: d[0], Tail: null};}  %}
...
NAME_OF_VARIABLE -> IDENTIFIER {%function(d) {return {Type: "port_identifier", Name: d[0], Location: d[0].Location};} %}
