...
var grammar = {
    ...
    {"name": "MODULE_INSTANTIATION$ebnf$1", "symbols": ["PARAMETER_VALUE_ASSIGNMENT"], "postprocess": id},
    {"name": "MODULE_INSTANTIATION$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "MODULE_INSTANTIATION", "symbols": ["IDENTIFIER", "MODULE_INSTANTIATION$ebnf$1", "IDENTIFIER", "_", (lexer.has("lparen") ? {type: "lparen"} : lparen), "_", "LIST_OF_PORT_CONNECTIONS", "_", (lexer.has("rparen") ? {type: "rparen"} : rparen), "_", (lexer.has("semicolon") ? {type: "semicolon"} : semicolon)], "postprocess": (d) => {return {Type: "module_instantiation", Module: d[0], Identifier: d[2], Connections: d[6], ParamOverrides: d[1]}}},
    {"name": "PARAMETER_VALUE_ASSIGNMENT", "symbols": [(lexer.has("hash") ? {type: "hash"} : hash), (lexer.has("lparen") ? {type: "lparen"} : lparen), "LIST_OF_PARAMTER_ASSIGNMENT", (lexer.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": (d) => {return d[2];}},
    {"name": "LIST_OF_PARAMTER_ASSIGNMENT$ebnf$1", "symbols": []},
    {"name": "LIST_OF_PARAMTER_ASSIGNMENT$ebnf$1$subexpression$1", "symbols": ["_", (lexer.has("comma") ? {type: "comma"} : comma), "_", "NAMED_PARAMETER_ASSIGNMENT"], "postprocess": (d)=> {return d[3];}},
    {"name": "LIST_OF_PARAMTER_ASSIGNMENT$ebnf$1", "symbols": ["LIST_OF_PARAMTER_ASSIGNMENT$ebnf$1", "LIST_OF_PARAMTER_ASSIGNMENT$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "LIST_OF_PARAMTER_ASSIGNMENT", "symbols": ["NAMED_PARAMETER_ASSIGNMENT", "LIST_OF_PARAMTER_ASSIGNMENT$ebnf$1", "_"], "postprocess": (d) => {return [d[0]].concat(d[1]);}},
    {"name": "NAMED_PARAMETER_ASSIGNMENT", "symbols": [(lexer.has("dot") ? {type: "dot"} : dot), "_", "IDENTIFIER", "_", (lexer.has("lparen") ? {type: "lparen"} : lparen), "_", "CONSTANT_EXPRESSION", "_", (lexer.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": (d) => {return {Type: "named_parameter_assignment", ParameterId: d[2], MinTypExpr: d[6]}}},
    ...
    {"name": "IF_GENERATE_CONSTRUCT$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "IF_GENERATE_CONSTRUCT", "symbols": [(lexer.has("t_if") ? {type: "t_if"} : t_if), (lexer.has("lparen") ? {type: "lparen"} : lparen), "CONSTANT_EXPRESSION", (lexer.has("rparen") ? {type: "rparen"} : rparen), "GENERATE_BLOCK_OR_NULL", "IF_GENERATE_CONSTRUCT$ebnf$1"], "postprocess": function(d) {
        let conditional = d[2];
        let if_block = d[4];
    ...
    {"name": "GENERATE_BLOCK_OR_NULL", "symbols": ["MODULE_OR_GENERATE_ITEM"], "postprocess": function(d) {return [d[0]];}},
    {"name": "GENERATE_BLOCK_OR_NULL$ebnf$1", "symbols": ["MODULE_OR_GENERATE_ITEM"]},
    ...
    {"name": "NON_PORT_MODULE_ITEM", "symbols": ["GENERATE_REGION"], "postprocess": id},
