...
var grammar = {
    ...
    {"name": "MODULE_PARAMETER_PORT_LIST", "symbols": [(lexer.has("hash") ? {type: "hash"} : hash), (lexer.has("lparen") ? {type: "lparen"} : lparen), "PARAMETER_DECLARATION", "MODULE_PARAMETER_PORT_LIST$ebnf$1", (lexer.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": function(d) {return {Type: "parameter_port_list", ParameterList: [d[2]].concat(d[3])};}},
    ...
    {"name": "PARAMETER_DECLARATION", "symbols": [(lexer.has("parameter") ? {type: "parameter"} : parameter), "LIST_OF_PARAM_ASSIGNMENTS"], "postprocess": function(d) {return {Type: "parameter_declaration", ParameterAssignmentList: d[1]};}},
