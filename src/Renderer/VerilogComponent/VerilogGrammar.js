...
lexer.next = (function (next) {
  return function () {
    ...
    } while (token && (token.type === "ws" || token.type === "comment" || token.type === "comment2" || token.type === "directives")); // Skip whitespace tokens
    return token;
  };
})(lexer.next);
var grammar = {
    Lexer: lexer,
    ParserRules: [
    {"name": "PROGRAM", "symbols": ["MODULE_DECLARATION"], "postprocess": function(d) {return {Type: "program", Module: d[0]};}},
    ...
    {"name": "MODULE_DECLARATION$subexpression$1", "symbols": ["MODULE_DECLARATION$subexpression$1$ebnf$1"], "postprocess": function(d) {return {Type: "module_items", ItemList: d[0]};}},
    ...
    {"name": "MODULE_DECLARATION$subexpression$2", "symbols": ["MODULE_DECLARATION$subexpression$2$ebnf$1"], "postprocess": function(d) {return {Type: "module_items", ItemList: d[0]};}},
    ...
    {"name": "LIST_OF_PORT_DECLARATIONS", "symbols": ["PORT_DECLARATION", "_", (lexer.has("comma") ? {type: "comma"} : comma), "_", "LIST_OF_PORT_DECLARATIONS"], "postprocess": function(d) {return {Type: "io_items", Head: d[0], Tail: d[4]};}},
    {"name": "LIST_OF_PORT_DECLARATIONS", "symbols": ["PORT_DECLARATION"], "postprocess": function(d) {return {Type: "io_items", Head: d[0], Tail: null};}},
    {"name": "PORT", "symbols": ["IDENTIFIER"], "postprocess": function(d) {return {Type: "port", Port: d[0], Location: d[0].Location};}},
    {"name": "PORT_DECLARATION", "symbols": ["INPUT_DECL"], "postprocess": function(d,l, reject) {return {Type: "item", ItemType: "input_decl", IODecl: d[0], ParamDecl: null, Statement: null, Location: d[0].Location};}},
    {"name": "PORT_DECLARATION", "symbols": ["OUTPUT_DECL"], "postprocess": function(d,l, reject) {return {Type: "item", ItemType: "output_decl", IODecl: d[0], ParamDecl: null, Statement: null, Location: d[0].Location};}},
    ...
    {"name": "REG_DECLARATION", "symbols": [(lexer.has("bit") ? {type: "bit"} : bit), "_", "REG_DECLARATION$ebnf$1", "LIST_OF_VARIABLES2", "_", (lexer.has("semicolon") ? {type: "semicolon"} : semicolon)], "postprocess":  (d,l,r) => {
    ...
    {"name": "CONTINUOUS_ASSIGNMENT", "symbols": ["assign", "_", "ASSIGNMENT", "_", (lexer.has("semicolon") ? {type: "semicolon"} : semicolon)], "postprocess": function(d) {return {Type: "statement", StatementType: "assign", Assignment: d[2], Location: d[0].Location};}},
    {"name": "CONTINUOUS_ASSIGNMENT", "symbols": ["logic", "_", "WIRE_ASSIGNMENT", "_", (lexer.has("semicolon") ? {type: "semicolon"} : semicolon)], "postprocess": function(d) {return {Type: "statement", StatementType: "wire", Assignment: d[2], Location: d[0].Location};}},
